            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-background rounded-lg p-4 mt-3">
                  <p className="text-sm text-text-secondary mb-2">External Video Player Settings:</p>
                  <code className="text-sm bg-surface p-2 rounded border border-secondary">
                    Recorded: https://edumastervideoplarerwatch.netlify.app/rec/<br/>
                    Live: https://edumastervideoplarerwatch.netlify.app/live/
                  </code>
                  <p className="text-xs text-text-tertiary mt-2">
                    Videos are played using external player embedded in modals
                  </p>
                </div>
              </div>
