    ...
    <div className="space-y-8 p-4">
      {batches.map((batch) => (
        ...
        >
          ...
          <div className="p-8 flex flex-col justify-center flex-1 bg-gray-600">
            <h3 className="font-semibold text-2xl text-white mb-3 group-hover:text-blue-300 transition-colors">{batch.name}</h3>
            <p className="text-base text-gray-300 mb-5 line-clamp-4">{batch.description}</p>
